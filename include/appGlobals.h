...
7. Optional: g_lightsOutOnPageLoad = false to keep lights on after page load.
-------------------------------------------------------------------*/
...
// was in secrets.h
String hostName = "ledman-volta";            // hostname as seen on network and home page
String friendlyName = "Volta";        // friendly name for home page
